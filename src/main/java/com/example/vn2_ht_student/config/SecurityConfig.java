...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, CustomAccessDeniedHandler customAccessDeniedHandler) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth ->auth.requestMatchers("/auth/**","/menus","/tasks/**","/user/**","/contribution-scores/**","/Group/**").permitAll().anyRequest().authenticated()).addFilterBefore(jwtFilter, UsernamePasswordAuthenticationFilter.class);
